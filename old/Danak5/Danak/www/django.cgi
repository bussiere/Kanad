...
try:
	...
	sys.path.append("/homez.113/dsxred/projet/danak")
	sys.path.append("/homez.113/dsxred/projet/django")
	sys.path.append("/homez.113/dsxred/projet")
	sys.path.append("/homez.113/dsxred/projet/django_extensions")
	...
	os.environ['DJANGO_SETTINGS_MODULE'] = 'danak.settings'

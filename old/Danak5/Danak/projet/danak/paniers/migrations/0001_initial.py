...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Panier'
        db.create_table('paniers_panier', (
            ...
            ('Date_paiement', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('Total', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('paniers', ['Panier'])

        # Adding M2M table for field Films on 'Panier'
        db.create_table('paniers_panier_Films', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('panier', models.ForeignKey(orm['paniers.panier'], null=False)),
            ('film', models.ForeignKey(orm['moteur.film'], null=False))
        ))
        db.create_unique('paniers_panier_Films', ['panier_id', 'film_id'])

        # Adding M2M table for field ImagesVente on 'Panier'
        db.create_table('paniers_panier_ImagesVente', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('panier', models.ForeignKey(orm['paniers.panier'], null=False)),
            ('imagevente', models.ForeignKey(orm['moteur.imagevente'], null=False))
        ))
        db.create_unique('paniers_panier_ImagesVente', ['panier_id', 'imagevente_id'])

        # Adding M2M table for field Packs on 'Panier'
        db.create_table('paniers_panier_Packs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('panier', models.ForeignKey(orm['paniers.panier'], null=False)),
            ('pack', models.ForeignKey(orm['moteur.pack'], null=False))
        ))
        db.create_unique('paniers_panier_Packs', ['panier_id', 'pack_id'])

        # Adding M2M table for field Tickets on 'Panier'
        db.create_table('paniers_panier_Tickets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('panier', models.ForeignKey(orm['paniers.panier'], null=False)),
            ('ticket', models.ForeignKey(orm['tickets.ticket'], null=False))
        ))
        db.create_unique('paniers_panier_Tickets', ['panier_id', 'ticket_id'])

        # Adding M2M table for field Note_divers on 'Panier'
        db.create_table('paniers_panier_Note_divers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('panier', models.ForeignKey(orm['paniers.panier'], null=False)),
            ('note_divers', models.ForeignKey(orm['notes.note_divers'], null=False))
        ))
        db.create_unique('paniers_panier_Note_divers', ['panier_id', 'note_divers_id'])


    def backwards(self, orm):
        
        # Deleting model 'Panier'
        db.delete_table('paniers_panier')

        # Removing M2M table for field Films on 'Panier'
        db.delete_table('paniers_panier_Films')

        # Removing M2M table for field ImagesVente on 'Panier'
        db.delete_table('paniers_panier_ImagesVente')

        # Removing M2M table for field Packs on 'Panier'
        db.delete_table('paniers_panier_Packs')

        # Removing M2M table for field Tickets on 'Panier'
        db.delete_table('paniers_panier_Tickets')

        # Removing M2M table for field Note_divers on 'Panier'
        db.delete_table('paniers_panier_Note_divers')

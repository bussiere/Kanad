...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('moteur_produit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Nom', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('moteur', ['Produit'])

        # Adding M2M table for field Film on 'Produit'
        db.create_table('moteur_produit_Film', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('produit', models.ForeignKey(orm['moteur.produit'], null=False)),
            ('film', models.ForeignKey(orm['moteur.film'], null=False))
        ))
        db.create_unique('moteur_produit_Film', ['produit_id', 'film_id'])

        # Adding M2M table for field Video on 'Produit'
        db.create_table('moteur_produit_Video', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('produit', models.ForeignKey(orm['moteur.produit'], null=False)),
            ('video', models.ForeignKey(orm['moteur.video'], null=False))
        ))
        db.create_unique('moteur_produit_Video', ['produit_id', 'video_id'])

        # Adding M2M table for field Pack on 'Produit'
        db.create_table('moteur_produit_Pack', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('produit', models.ForeignKey(orm['moteur.produit'], null=False)),
            ('pack', models.ForeignKey(orm['moteur.pack'], null=False))
        ))
        db.create_unique('moteur_produit_Pack', ['produit_id', 'pack_id'])

        # Adding M2M table for field ImageVente on 'Produit'
        db.create_table('moteur_produit_ImageVente', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('produit', models.ForeignKey(orm['moteur.produit'], null=False)),
            ('imagevente', models.ForeignKey(orm['moteur.imagevente'], null=False))
        ))
        db.create_unique('moteur_produit_ImageVente', ['produit_id', 'imagevente_id'])

        # Adding M2M table for field ImagePrincipale on 'Film'
        db.create_table('moteur_film_ImagePrincipale', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('film', models.ForeignKey(orm['moteur.film'], null=False)),
            ('imagefilm', models.ForeignKey(orm['moteur.imagefilm'], null=False))
        ))
        db.create_unique('moteur_film_ImagePrincipale', ['film_id', 'imagefilm_id'])


    def backwards(self, orm):
        
        # Deleting model 'Produit'
        db.delete_table('moteur_produit')

        # Removing M2M table for field Film on 'Produit'
        db.delete_table('moteur_produit_Film')

        # Removing M2M table for field Video on 'Produit'
        db.delete_table('moteur_produit_Video')

        # Removing M2M table for field Pack on 'Produit'
        db.delete_table('moteur_produit_Pack')

        # Removing M2M table for field ImageVente on 'Produit'
        db.delete_table('moteur_produit_ImageVente')

        # Removing M2M table for field ImagePrincipale on 'Film'
        db.delete_table('moteur_film_ImagePrincipale')
